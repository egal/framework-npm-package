...
// @ts-ignore
const ValidationConstructor_1 = require("./compile/src/Constructors/ValidationConstructor");
// simple rules
let data = {
    name: '',
    salary: '10,000.00',
...
// };
let validator = new ValidationConstructor_1.ValidationConstructor(data, rules, message);
function validateInputs() {
    validator.createValidationRule('telephone', function (value) {
