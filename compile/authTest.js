...
let newAuth = new AuthConstructor_1.EgalAuthConstructor({ modelName: 'User', userName: 'admin', password: 'password', url: 'http://breaker-develop.sputnikfund.ru/api', connectionType: 'axios' });
...
function egalLoginToService(data) {
